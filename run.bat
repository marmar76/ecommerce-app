@REM SET MONGO_URL=mongodb://administrator:6LGuwq2jhzVTqpFT@marmar-shard-00-00.hiryh.mongodb.net:27017,marmar-shard-00-01.hiryh.mongodb.net:27017,marmar-shard-00-02.hiryh.mongodb.net:27017/e-commerce?ssl=true&replicaSet=atlas-3u57yy-shard-0&authSource=admin&retryWrites=true&w=majority
...
@REM meteor
SET GOOGLE_APPLICATION_CREDENTIALS=lycoris-f6d59698cb49.json
